...
class OpenAIService:
    ...
    async def create_chat_completion(
        ...
        **kwargs
        ...
        try:
            ...
            raise OpenAIError(f"Rate limit exceeded: {e}")
    ...
    async def create_embedding(
        ...
        try:
            ...
            raise OpenAIError(f"Embedding creation failed: {e}")
    ...
    async def create_embeddings_batch(
        ...
        for i in range(0, len(texts), batch_size):
            ...
            try:
                ...
                raise OpenAIError(f"Batch embedding failed at batch {i//batch_size + 1}: {e}")
