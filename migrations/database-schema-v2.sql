...
-- Stores user profile information with OAuth tokens (updated for v2)
...
CREATE TABLE whoop_sleep (
    ...
    v1_id BIGINT, -- v1 ID for backwards compatibility
    user_id BIGINT REFERENCES whoop_users(id) ON DELETE CASCADE,
...
CREATE INDEX idx_whoop_sleep_v1_id ON whoop_sleep(v1_id);
CREATE INDEX idx_whoop_workouts_user_id ON whoop_workouts(user_id);
CREATE INDEX idx_whoop_workouts_v1_id ON whoop_workouts(v1_id);
