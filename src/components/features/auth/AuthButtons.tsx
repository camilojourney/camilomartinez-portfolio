    ...
    return (
        <div className="flex items-center gap-6">
            ...
            >
                <button
                    type="submit"
                    className="text-white/60 hover:text-foreground transition-colors duration-300 text-sm font-medium px-4 py-2 rounded-lg hover:bg-white/[0.05]"
                >
                    Disconnect
                </button>
            </form>
