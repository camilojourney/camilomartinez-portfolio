    ...
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center">
      ...
      <div className="text-center px-4 max-w-lg mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link
            href="/"
            className="group inline-flex items-center justify-center gap-2.5 bg-gradient-to-r from-cyan-500/15 to-blue-500/15 border border-cyan-400/20 text-foreground font-medium px-8 py-3.5 rounded-2xl hover:from-cyan-500/25 hover:to-blue-500/25 hover:border-cyan-400/35 transition-all duration-300 shadow-lg shadow-cyan-500/5"
          >
          ...
          <Link
            href="/projects"
            className="group inline-flex items-center justify-center gap-2 bg-white/[0.06] border border-white/[0.08] text-white/70 font-medium px-8 py-3.5 rounded-2xl hover:text-foreground hover:bg-white/[0.10] hover:border-white/[0.14] transition-all duration-300"
          >
            View Work
            <svg className="w-4 h-4 transition-transform duration-300 group-hover:translate-x-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-14 flex items-center justify-center gap-6 text-sm text-muted-foreground">
          <Link href="/blog" className="hover:text-muted-foreground transition-colors duration-200">Blog</Link>
          <span className="w-1 h-1 rounded-full bg-white/15"></span>
          <Link href="/about" className="hover:text-muted-foreground transition-colors duration-200">About</Link>
          <span className="w-1 h-1 rounded-full bg-white/15"></span>
