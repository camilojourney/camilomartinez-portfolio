        ...
        <LiquidPage currentPage="about" backgroundVariant="purple">
            <section className="liquid-glass-card backdrop-blur-2xl bg-white/[0.06] border border-white/[0.1] rounded-3xl p-8 md:p-12 max-w-4xl w-full shadow-2xl shadow-black/20">
                <div className="text-center">
                    ...
                    <ul className="text-muted-foreground text-left max-w-md mx-auto mb-8 space-y-2">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <Link
                            href="/"
                            className="liquid-glass-btn backdrop-blur-lg bg-white/[0.05] border border-white/[0.12] text-white/80 px-6 py-3 rounded-xl hover:bg-white/[0.08] hover:border-white/[0.16] hover:text-foreground transition-all duration-300 transform hover:scale-[1.02] shadow-lg inline-flex items-center justify-center gap-2"
                        >
                            Back to Home
                        </Link>
                    </div>
