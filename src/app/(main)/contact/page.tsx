      ...
      <div className="pt-32 md:pt-40 px-4 md:px-6 pb-20">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="hero-stagger hero-stagger-3 text-xl md:text-2xl text-white/70 max-w-3xl mx-auto leading-relaxed">
              Seeking{' '}
          ...
          <div className="hero-stagger hero-stagger-4 flex flex-col sm:flex-row gap-4 justify-center mb-16">
            ...
            <a
              ...
              className="group inline-flex items-center justify-center gap-3 bg-white/[0.06] border border-white/[0.10] text-white text-lg font-medium px-8 py-4 rounded-2xl hover:bg-white/[0.10] hover:border-white/[0.16] transition-all duration-300 transform hover:scale-[1.02]"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
            ...
            <div className="backdrop-blur-2xl bg-white/[0.04] border border-white/[0.08] rounded-2xl p-6 text-center hover:bg-white/[0.06] hover:border-white/[0.12] transition-all duration-300">
              ...
              <p className="text-white/60 text-sm">New York City, NY</p>
            </div>
            ...
            <div className="backdrop-blur-2xl bg-white/[0.04] border border-white/[0.08] rounded-2xl p-6 text-center hover:bg-white/[0.06] hover:border-white/[0.12] transition-all duration-300">
              ...
              <p className="text-white font-medium mb-1">Availability</p>
          ...
          <div className="backdrop-blur-2xl bg-white/[0.03] border border-white/[0.06] rounded-2xl p-8 max-w-3xl mx-auto text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
              ...
              <div className="text-white/60">
                <p className="text-2xl font-bold text-white mb-1">NYC</p>
