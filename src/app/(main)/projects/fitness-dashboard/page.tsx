  ...
  return (
    <LiquidPage currentPage="projects" backgroundVariant="cool" className="pt-32 md:pt-40">
      <div className="w-full max-w-4xl mx-auto px-4 md:px-0 py-12 space-y-12">
        ...
        <div className="liquid-glass-card backdrop-blur-2xl bg-white/[0.06] border border-white/[0.1] rounded-3xl overflow-hidden">
        ...
        <div className="liquid-glass-card backdrop-blur-2xl bg-gradient-to-br from-emerald-500/15 to-cyan-500/10 border border-emerald-400/30 rounded-3xl p-8 md:p-10 text-center space-y-4">
