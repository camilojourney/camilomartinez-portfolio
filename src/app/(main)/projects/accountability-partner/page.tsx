    ...
    <StandardPage currentPage="projects" maxWidth="default">
      <div className="space-y-12">
        ...
        <Card className="border-white/10 bg-white/[0.05] p-8 md:p-10 space-y-6">
          <h2 className="text-2xl md:text-3xl font-semibold text-foreground">The Challenge</h2>
        ...
        <Card className="border-white/10 bg-white/[0.05] p-8 md:p-10 space-y-6">
          <h2 className="text-2xl md:text-3xl font-semibold text-foreground">Why Morning Workouts Matter</h2>
          ...
          <ul className="list-disc list-inside space-y-3 text-muted-foreground text-base md:text-lg">
            <li><span className="text-foreground font-medium">Sets the tone</span> for discipline and momentum throughout the day</li>
            <li><span className="text-foreground font-medium">Eliminates excuses</span> before work, meetings, or fatigue can derail plans</li>
            <li><span className="text-foreground font-medium">Builds consistency</span> through non-negotiable morning rituals</li>
            <li><span className="text-foreground font-medium">Creates accountability</span> when tracked publicly</li>
          </ul>
        </Card>

        <Card className="border-white/10 bg-white/[0.05] p-8 md:p-10 space-y-6">
          <h2 className="text-2xl md:text-3xl font-semibold text-foreground">Technical Implementation</h2>
          <ul className="list-disc list-inside space-y-4 text-muted-foreground text-base md:text-lg">
            <li><span className="text-foreground font-medium">WHOOP API integration</span> automatically pulls workout start times</li>
            <li><span className="text-foreground font-medium">Timezone normalization</span> converts UTC timestamps to New York time for accurate tracking</li>
            <li><span className="text-foreground font-medium">Interactive visualization</span> displays workout times with color-coded success/failure markers</li>
            <li><span className="text-foreground font-medium">Real-time updates</span> via ISR (Incremental Static Regeneration) every 6 hours</li>
            <li><span className="text-foreground font-medium">Goal tracking</span> with clear visual indicators for before/after 8:30 AM threshold</li>
          </ul>
        </Card>

        <Card className="border-white/10 bg-white/[0.05] p-8 md:p-10 space-y-6">
          <h2 className="text-2xl md:text-3xl font-semibold text-foreground">The Power of Public Accountability</h2>
          <p className="text-muted-foreground leading-relaxed text-base md:text-lg">
        ...
        <Card className="border-white/10 bg-gradient-to-br from-amber-500/15 to-orange-500/10 border-amber-400/30 p-8 md:p-10 text-center space-y-4">
          <h3 className="text-2xl font-semibold text-foreground">Track my progress</h3>
          <p className="text-muted-foreground">See how I'm doing with my morning workout commitment in real-time.</p>
          <Link
