...
const projects: ProjectData[] = [
    ...
    },
    {
        ...
        summary: 'Speech ML pipeline built from 46 research papers with 7-dimension hybrid scoring for intelligibility, acoustic delivery, and language quality.',
        fullDescription: 'Invoz analyzes spoken English with a 7-dimension hybrid scoring architecture: GOPT-style acoustic scoring for accuracy, fluency, prosody, and intelligibility, plus transcript/LLM scoring for vocabulary, grammar, and coherence. Built from 46 research papers in speech pathology and computational linguistics.',
        ...
        solution: 'A privacy-aware multi-model pipeline: GOPT-style acoustic scoring for labeled speech dimensions, Whisper/Parakeet-style intent recovery, wav2vec2 phoneme analysis, Parselmouth acoustic features, Silero VAD segmentation, and Claude for linguistic coaching.',
        outcome: 'Speakers get actionable, dimension-specific feedback centered on intelligibility and the top acoustic or linguistic issues. Public demo at invoz.io; private learner audio and transcripts are not exposed.',
        techStack: ['Python', 'FastAPI', 'Whisper', 'wav2vec2', 'Parselmouth', 'Silero VAD', 'Claude API'],
        features: [
            '7-dimension hybrid scoring across acoustic and linguistic dimensions',
            'Supervised acoustic scoring trained and evaluated on labeled SpeechOcean762 data',
            ...
            'Privacy-aware public demo without raw learner audio or transcript exposure',
        ],
        status: 'live',
