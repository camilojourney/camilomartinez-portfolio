...
const projects: ProjectData[] = [
    ...
    },
    {
        slug: 'holusight',
        title: 'Holusight',
        summary: 'Enterprise document intelligence platform — semantic search across internal knowledge bases with AI-powered consulting workflows.',
        fullDescription: 'Holusight is an enterprise AI platform that transforms how organizations access and act on their internal knowledge. It ingests documents, contracts, reports, and wikis, then makes them instantly searchable and actionable through natural language — replacing hours of manual research with seconds of semantic retrieval.',
        problem: 'Enterprise teams drown in documents. Critical knowledge is locked in PDFs, Notion pages, Confluence wikis, and email threads. Finding the right answer means hours of manual search, and that knowledge is never connected to action.',
        solution: 'A semantic search layer built on top of your existing knowledge base. Holusight ingests any document format, builds a vector index, and surfaces exact answers — not just results. The AI layer understands context, synthesizes across sources, and routes queries to the right workflow.',
        outcome: 'Enterprise teams reduce knowledge retrieval from hours to seconds. Consultants get AI-assisted research workflows. Organizations finally get ROI on the knowledge they already have.',
        techStack: ['Next.js', 'Python', 'OpenAI Embeddings', 'Supabase pgvector', 'TypeScript', 'Tailwind CSS'],
        features: [
            'Semantic search across all document formats (PDF, Notion, Confluence, Drive)',
            'AI-powered answer synthesis across multiple sources',
            'Consulting workflow automation',
            'Multi-tenant enterprise architecture',
            'Real-time document ingestion pipeline',
            'Role-based access control per knowledge base',
        ],
        status: 'live',
        appLink: 'https://holusight.com',
