    ...
    <StandardPage currentPage="projects" maxWidth="default">
      <div className="space-y-12">
          ...
          <Card className="border-white/10 bg-white/[0.05] p-8 md:p-10 space-y-6">
            <h2 className="text-2xl md:text-3xl font-semibold text-foreground">Why I Built This</h2>
            <div className="space-y-4 text-muted-foreground leading-relaxed text-base md:text-lg">
              ...
              <p>
                Existing timers and Pomodoro apps weren't built for this. They assume you want to <em>stop</em> working, but hyperfocus doesn't work that way. What I needed was <span className="text-foreground font-medium">gentle awareness</span>—periodic check-ins that keep me grounded without breaking flow.
              </p>
              <p>
          ...
          <Card className="border-white/10 bg-white/[0.05] p-8 md:p-10 space-y-6">
            <h2 className="text-2xl md:text-3xl font-semibold text-foreground">Technical Architecture</h2>
            ...
            <ul className="list-disc list-inside space-y-4 text-muted-foreground text-base md:text-lg">
              <li>
                <span className="text-foreground font-medium">Tauri 2.x</span> — Rust + JavaScript hybrid framework for native macOS menu bar apps with minimal memory footprint
              </li>
              <li>
                <span className="text-foreground font-medium">Rust backend</span> — System tray integration, macOS Calendar API (EventKit) access, and JSONL logging with zero network dependencies
              </li>
              <li>
                <span className="text-foreground font-medium">Vanilla JavaScript frontend</span> — Lightweight, framework-free UI with smooth animations and keyboard shortcuts
              </li>
              <li>
                <span className="text-foreground font-medium">Local-first storage</span> — All focus session data stored in JSONL format in Tauri's sandboxed app directory
              </li>
              <li>
                <span className="text-foreground font-medium">Native macOS APIs</span> — Direct EventKit integration pulls current calendar meeting as suggested focus goal
              </li>
            </ul>
          </Card>

          <Card className="border-white/10 bg-white/[0.05] p-8 md:p-10 space-y-6">
            <h2 className="text-2xl md:text-3xl font-semibold text-foreground">Key Features</h2>
          ...
          <Card className="border-white/10 bg-white/[0.05] p-8 md:p-10 space-y-6">
            <h2 className="text-2xl md:text-3xl font-semibold text-foreground">Technical Challenges Solved</h2>
            <div className="space-y-4 text-muted-foreground leading-relaxed text-base md:text-lg">
              <p>
              ...
              <p>
                <span className="text-foreground font-medium">macOS Calendar API Integration:</span> Bridged Rust with Objective-C EventKit APIs to fetch current calendar events, handling permission prompts and error states gracefully.
              </p>
              <p>
                <span className="text-foreground font-medium">JSONL Logging for Session Data:</span> Designed append-only log format for focus check-ins that supports efficient reads, search, and future analytics without a database.
              </p>
            </div>
          </Card>

          <Card className="border-white/10 bg-white/[0.05] p-8 md:p-10 space-y-6">
            <h2 className="text-2xl md:text-3xl font-semibold text-foreground">Tech Stack</h2>
          ...
          <Card className="border-white/10 bg-gradient-to-br from-purple-500/15 to-blue-500/10 border-purple-400/30 p-8 md:p-10 text-center space-y-4">
            <h3 className="text-2xl font-semibold text-foreground">Download Focus Time</h3>
            <p className="text-muted-foreground">Available for macOS and Windows. All focus data stays local on your machine.</p>
            <Link
              href="/apps/focus-time"
              className="inline-flex items-center gap-2 rounded-xl border border-white/20 bg-white/10 px-6 py-3 text-foreground font-medium transition-all duration-300 hover:scale-105 hover:border-purple-300/60 hover:text-purple-100"
            >
            Download App →
          </Link>
        </Card>
