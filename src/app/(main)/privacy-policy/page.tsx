...
export default function PrivacyPolicyPage() {
  return (
    <LiquidPage backgroundVariant="cool">
      <section className="liquid-glass-card backdrop-blur-2xl bg-white/[0.06] border border-white/[0.1] rounded-3xl p-8 md:p-12 max-w-4xl w-full shadow-2xl shadow-black/20">
        <div className="text-center mb-10">
          <h1 className="text-4xl md:text-5xl font-extralight text-foreground mb-4 drop-shadow-lg">Privacy Policy</h1>
        ...
        <div className="space-y-8 text-foreground">
          <div>
            <h2 className="text-2xl font-light mb-3">1. Introduction</h2>
            <p className="mb-4">
              Welcome to Camilo Martinez's portfolio website. This Privacy Policy explains how we collect, use, disclose, 
              and safeguard your information when you visit our website at camilomartinez.co, including any other media form, 
          ...
          <div>
            <h2 className="text-2xl font-light mb-3">2. Collection of Your Information</h2>
            <p className="mb-3">
              We may collect information about you in a variety of ways. The information we may collect via the Site includes:
            </p>
            <h3 className="text-xl font-light mb-2">Personal Data</h3>
            <p className="mb-3">
              Personally identifiable information, such as your name and email address, that you voluntarily give to us when you
              choose to participate in various activities related to the Site, such as message boards, online chat, contact forms,
              and surveys. You are under no obligation to provide us with personal information of any kind, however, your refusal
              to do so may prevent you from using certain features of the Site.
            </p>

            <h3 className="text-xl font-light mb-2">Derivative Data</h3>
            <p className="mb-3">
            ...
            <h3 className="text-xl font-light mb-2">Third-Party Data</h3>
            <p>
              Information from third parties, such as personal information or network friends, if you connect your account to the third party
              and grant the Site permission to access this information.
            </p>
          </div>

          <div>
            <h2 className="text-2xl font-light mb-3">3. Use of Your Information</h2>
            <p className="mb-3">
          ...
          <div>
            <h2 className="text-2xl font-light mb-3">4. Disclosure of Your Information</h2>
            <p className="mb-3">
              We may share information we have collected about you in certain situations. Your information may be disclosed as follows:
            </p>

            <h3 className="text-xl font-light mb-2">By Law or to Protect Rights</h3>
            <p className="mb-3">
              ...
              violations of our policies, or to protect the rights, property, and safety of others, we may share your information as permitted or
              required by any applicable law, rule, or regulation.
            </p>

            <h3 className="text-xl font-light mb-2">Third-Party Service Providers</h3>
            <p className="mb-3">
            ...
            <h3 className="text-xl font-light mb-2">Online Postings</h3>
            <p className="mb-3">
              When you post comments, contributions or other content to the Site, your posts may be viewed by all users and may be publicly
              distributed outside the Site in perpetuity.
            </p>
          </div>

          <div>
            <h2 className="text-2xl font-light mb-3">5. Security of Your Information</h2>
            <p className="mb-3">
          ...
          <div>
            <h2 className="text-2xl font-light mb-3">6. Policy for Children</h2>
            <p className="mb-3">
          ...
          <div>
            <h2 className="text-2xl font-light mb-3">7. Controls for Do-Not-Track Features</h2>
            <p className="mb-3">
              ...
              respond to DNT browser signals or any other mechanism that automatically communicates your choice not to be tracked online.
            </p>
          </div>

          <div>
            <h2 className="text-2xl font-light mb-3">8. Changes to This Privacy Policy</h2>
            <p className="mb-3">
              We may update this Privacy Policy from time to time. The updated version will be indicated by an updated
              "Last Updated" date and the updated version will be effective as soon as it is accessible. We encourage you to
              review this Privacy Policy frequently to be informed of how we are protecting your information.
            </p>
          </div>

          <div>
            <h2 className="text-2xl font-light mb-3">9. Contact Us</h2>
            <p className="mb-3">
