...
when I ran the above code, it produced a nice map of the Astoria street network, which I saved as a PNG file for reference.
The data I get after running is a polyline that represents the GPS track of my run. This polyline is encoded in a compact format, which I can decode to get the actual latitude and longitude points of my run. 
after decoding the polyline, I matched the GPS points to the nearest streets in the Astoria street network using a map-matching algorithm. This step is crucial because GPS data can be noisy, and I want to ensure that my run follows the actual streets as closely as possible.
...
#| fig-subcap: 
#|   - "(a) Original GPS Track from Strava"
#|   - "(b) Matched Track on Astoria Streets"
#| layout-ncol: 2
#| code-fold: true
#| message: false
