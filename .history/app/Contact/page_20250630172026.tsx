    ...
    return (
        <section className="fixed inset-0 w-full h-full flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 max-w-3xl mx-auto px-6">
                <div className="liquid-glass-card backdrop-blur-2xl bg-white/[0.06] border border-white/[0.1] rounded-3xl p-12 shadow-2xl shadow-black/20">
                    {/* Header with concentric design */}
                    <div className="text-center mb-16">
                        <h1 className="text-5xl md:text-6xl font-extralight text-white mb-6 drop-shadow-lg">
                            Let's Connect
                        </h1>
