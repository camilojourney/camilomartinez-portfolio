...
export default function ContactPage() {
    return (
        <>
            ...
            `}</style>
            <section className="relative w-screen min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 -mx-4 lg:-mx-auto">
