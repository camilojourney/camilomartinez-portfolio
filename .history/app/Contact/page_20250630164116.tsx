...
export default function ContactPage() {
    return (
        <div className="fixed inset-0 w-full h-full">
            <section className="relative w-full h-full flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
                        ...
                        >
                            <div className="flex items-center space-x-4">
                                ...
                                <div className="text-left">
                                    <p className="text-lg font-semibold text-white group-hover:text-cyan-400 transition-colors">Email Me</p>
                        ...
                        <div className="group relative">
                            ...
                            >
                                <div className="flex items-center space-x-3">
                                    ...
                                    <span className="text-white font-semibold group-hover:text-blue-400 transition-colors">LinkedIn</span>
                                </div>
                            </a>
                        </div>
