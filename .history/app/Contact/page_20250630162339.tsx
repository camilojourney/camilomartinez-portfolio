        ...
        <section className="flex flex-col items-center justify-center min-h-screen text-center p-4">
            <div className="max-w-lg">
                ...
                <div className="space-y-6">
                    <a href="mailto:camilomartinez.ai@outlook.com" className="block text-xl font-bold text-cyan-400 hover:underline">
                        camilomartinez.ai@outlook.com
                    </a>
                    <div className="flex justify-center space-x-6">
                        <a href="https://www.linkedin.com/in/camilomartinez-ai/" target="_blank" rel="noopener noreferrer" className="text-lg hover:text-cyan-400 transition-colors">
                            LinkedIn
                        </a>
