...
export default function ContactPage() {
    return (
        <section className="fixed inset-0 w-full h-full overflow-y-auto overflow-x-hidden">
            ...
            <div className="relative z-10 min-h-screen flex items-center justify-center py-16 px-6">
                <div className="liquid-glass-card backdrop-blur-2xl bg-white/[0.06] border border-white/[0.1] rounded-3xl p-6 md:p-8 shadow-2xl shadow-black/20 w-full max-w-2xl">
                    {/* Header with concentric design */}
                    <div className="text-center mb-8">
                        <h1 className="text-3xl md:text-4xl font-extralight text-white mb-4 drop-shadow-lg">
                            Let's Connect
                        </h1>
                        <div className="w-16 h-px bg-gradient-to-r from-transparent via-cyan-400/60 to-transparent mx-auto mb-6"></div>
                        <p className="text-base md:text-lg text-white/80 leading-relaxed max-w-xl mx-auto font-light">
                        ...
                        <div className="group">
                            ...
                            >
                                <div className="flex items-center space-x-4 w-full">
                                    <div className="liquid-glass-icon backdrop-blur-lg bg-gradient-to-br from-cyan-400/20 to-blue-500/20 border border-cyan-300/20 rounded-2xl p-3 group-hover:from-cyan-400/30 group-hover:to-blue-500/30 transition-all duration-300">
                                        <svg className="w-6 h-6 text-cyan-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                        </svg>
                                    </div>
                                    <div className="text-left flex-1">
                                        <p className="text-lg font-medium text-white group-hover:text-cyan-300 transition-colors duration-300">Send Email</p>
                                        <p className="text-cyan-400/80 font-mono text-sm mt-1">camilomartinez.ai@outlook.com</p>
                                    </div>
                                    <svg className="w-5 h-5 text-white/40 group-hover:text-cyan-400 group-hover:translate-x-1 transition-all duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="group">
                                <a
                                    ...
                                    className="liquid-glass-contact-card backdrop-blur-xl bg-white/[0.04] border border-white/[0.08] rounded-2xl p-4 hover:bg-white/[0.06] hover:border-white/[0.12] transition-all duration-500 hover:transform hover:scale-[1.02] hover:shadow-xl hover:shadow-blue-500/10 flex items-center group-hover:border-blue-400/30 shimmer-on-hover"
                                >
                                    <div className="flex items-center space-x-3 w-full">
                                        <div className="liquid-glass-icon backdrop-blur-lg bg-gradient-to-br from-blue-400/20 to-cyan-400/20 border border-blue-300/20 rounded-xl p-2 group-hover:from-blue-400/30 group-hover:to-cyan-400/30 transition-all duration-300">
                                        ...
                                        <div className="text-left flex-1">
                                            <span className="text-base font-medium text-white group-hover:text-blue-300 transition-colors duration-300">Connect on LinkedIn</span>
                                        </div>
                                        <svg className="w-4 h-4 text-white/40 group-hover:text-blue-400 group-hover:translate-x-1 transition-all duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 5l7 7-7 7" />
                                        </svg>
                                    </div>
                                </a>
                            ...
                            <div className="group">
                                ...
                                >
                                    <div className="flex items-center space-x-3 w-full">
                                        <div className="liquid-glass-icon backdrop-blur-lg bg-gradient-to-br from-purple-400/20 to-pink-400/20 border border-purple-300/20 rounded-xl p-2 group-hover:from-purple-400/30 group-hover:to-pink-400/30 transition-all duration-300">
                                        ...
                                        <div className="text-left flex-1">
                                            <span className="text-base font-medium text-white group-hover:text-purple-300 transition-colors duration-300">GitHub</span>
                                        </div>
                                        <svg className="w-4 h-4 text-white/40 group-hover:text-purple-400 group-hover:translate-x-1 transition-all duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 5l7 7-7 7" />
                                        </svg>
                                    </div>
                                </a>
                    ...
                    <div className="text-center">
                        <p className="text-white/60 mb-4 text-base font-light">Based in the intersection of data and creativity</p>
