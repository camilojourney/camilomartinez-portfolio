    ...
    return (
        <section className="fixed inset-0 w-full h-full overflow-y-auto overflow-x-hidden">
            ...
            <div className="relative z-10 min-h-screen flex items-center justify-center py-24 px-6">
                <div className="liquid-glass-card backdrop-blur-2xl bg-white/[0.06] border border-white/[0.1] rounded-3xl p-8 md:p-12 shadow-2xl shadow-black/20 w-full max-w-3xl">
