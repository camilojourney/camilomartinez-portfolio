...
export default function ContactPage() {
    return (
        <div className="absolute top-0 left-0 w-full min-h-screen -z-10">
            <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
