...
export default function ContactPage() {
    return (
        <section className="relative -mx-2 md:-mx-0 -mt-6 w-screen left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
