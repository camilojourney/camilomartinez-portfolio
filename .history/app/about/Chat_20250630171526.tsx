...
export default function Chat() {
    ...
    const getBotResponse = (question: string): string => {
        ...
        if (q.includes('soft skills')) {
            return "Based on mock data from his Whoop sensor, my average sleep last week was 7 hours and 15 minutes, consistent with my quarterly average. I track sleep performance as a key metric for optimal cognitive output."; // Add full answer
        }
        if (q.includes('sleep')) {
