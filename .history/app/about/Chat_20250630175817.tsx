...
export default function Chat() {
    ...
    return (
        <div className="liquid-glass-chat-container max-w-full mx-auto">
            ...
            <form onSubmit={handleSendMessage} className="p-6 border-t border-white/[0.08]">
                <div className="relative">
                    <input
                        ...
                        className="w-full liquid-glass-input backdrop-blur-lg bg-white/[0.05] border border-white/[0.12] text-white placeholder-white/50 rounded-2xl pl-6 pr-16 py-4 text-lg focus:outline-none focus:ring-2 focus:ring-cyan-500/50 focus:border-cyan-400/50 transition-all duration-300"
                    />
                    <button
                        type="submit"
                        className="absolute right-2 top-1/2 transform -translate-y-1/2 liquid-glass-send-btn backdrop-blur-lg bg-gradient-to-r from-cyan-500/20 to-blue-500/20 border border-cyan-400/30 text-cyan-300 p-3 rounded-xl hover:from-cyan-400/30 hover:to-blue-400/30 hover:border-cyan-300/50 hover:text-cyan-200 transition-all duration-300 transform hover:scale-[1.05] shadow-lg group"
                    >
                        <svg className="w-5 h-5 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" fill="currentColor" viewBox="0 0 20 20">
