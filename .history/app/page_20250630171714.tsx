        ...
        <div className="min-h-full flex items-center justify-center p-8 pt-20">
          ...
          <section className="liquid-glass-card backdrop-blur-2xl bg-white/[0.06] border border-white/[0.1] rounded-3xl p-8 md:p-10 max-w-4xl w-full shadow-2xl shadow-black/20">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 mb-16">
              ...
              <Link
                href="/contact"
                className="group liquid-glass-secondary backdrop-blur-xl bg-white/[0.04] border border-white/[0.15] text-white/90 font-medium py-3 px-8 rounded-2xl hover:bg-white/[0.08] hover:border-white/[0.25] hover:text-white transition-all duration-300 transform hover:scale-[1.02]"
              >
            ...
            <div className="mb-16">
              <div className="text-center mb-8">
                <h2 className="text-2xl md:text-3xl font-light text-white mb-3">Featured Work</h2>
                <div className="w-12 h-px bg-gradient-to-r from-transparent via-cyan-400/40 to-transparent mx-auto"></div>
              </div>
            ...
            <div className="text-center">
              <h2 className="text-2xl md:text-3xl font-light text-white mb-3">Latest Thoughts</h2>
              <div className="w-12 h-px bg-gradient-to-r from-transparent via-cyan-400/40 to-transparent mx-auto mb-8"></div>
              <div className="liquid-glass-blog backdrop-blur-xl bg-white/[0.03] border border-white/[0.06] rounded-2xl p-6">
                <BlogPosts />
              </div>
            </div>
          </section>
