      ...
      <div className="liquid-glass-card backdrop-blur-2xl bg-white/[0.04] border border-white/[0.08] rounded-3xl p-6 md:p-8 max-w-4xl mx-auto shadow-xl shadow-black/10">
        <ul className="flex flex-col space-y-3 md:flex-row md:space-y-0 md:space-x-6 md:justify-center text-white/80">
          ...
          <li>
            ...
            >
              <LinkedInIcon />
              <p className="ml-3 h-7 text-sm md:text-base">linkedin</p>
            </a>
          </li>
          <li>
            <a
            ...
            >
              <InstagramIcon />
              <p className="ml-3 h-7 text-sm md:text-base">instagram</p>
            </a>
          </li>
          <li>
            <a
            ...
            >
              <XIcon />
              <p className="ml-3 h-7 text-sm md:text-base">x</p>
            </a>
          </li>
          <li>
            <a
            ...
            >
              <YouTubeIcon />
              <p className="ml-3 h-7 text-sm md:text-base">youtube</p>
            </a>
          </li>
        </ul>
